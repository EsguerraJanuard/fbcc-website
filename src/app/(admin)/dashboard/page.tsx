  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
      <div>
        ...
        <p className="text-gray-500">Here is what's happening across the FBCC platform today.</p>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        
        {/* Sermons Card */}
        <Link href="/dashboard/sermons" className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-lg transition-shadow duration-300 relative overflow-hidden group block">
          <div className="absolute top-0 right-0 p-6 opacity-10 transform group-hover:scale-110 transition-transform duration-500 text-fbcc-navy">
          ...
          <div className="relative z-10">
            <h2 className="text-sm font-bold uppercase tracking-widest text-gray-500 mb-2">Total Sermons</h2>
            <p className="text-5xl font-serif font-bold text-fbcc-navy mb-4">{sermonCount || 0}</p>
        ...
        {/* Events Card */}
        <Link href="/dashboard/events" className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-lg transition-shadow duration-300 relative overflow-hidden group block">
          <div className="absolute top-0 right-0 p-6 opacity-10 transform group-hover:scale-110 transition-transform duration-500 text-fbcc-ocean dark:text-blue-300">
          ...
          <div className="relative z-10">
            <h2 className="text-sm font-bold uppercase tracking-widest text-gray-500 mb-2">Upcoming Events</h2>
        ...
        {/* Prayers Card */}
        <Link href="/dashboard/prayers" className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-lg transition-shadow duration-300 relative overflow-hidden group block">
          <div className="absolute top-0 right-0 p-6 opacity-10 transform group-hover:scale-110 transition-transform duration-500 text-fbcc-earth dark:text-emerald-400">
          ...
          <div className="relative z-10">
            <h2 className="text-sm font-bold uppercase tracking-widest text-gray-500 mb-2">Pending Prayers</h2>
